...
<div class="mb-8">
    <div class="flex items-center space-x-2 mb-2">
        ...
        <div class="text-[#00B7EB] text-sm font-medium tracking-wider">CREATE CATEGORY</div>
    </div>
    <h2 class="text-3xl font-bold text-gray-800">Add New Category</h2>
    <p class="text-gray-600 mt-1">Add a new category for blogs on Ordecity.</p>
</div>
...
<div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
    ...
    <form action="{{ route('categories.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-[#1E90FF] focus:border-[#1E90FF] transition-all" placeholder="Enter category name" required>
        </div>
