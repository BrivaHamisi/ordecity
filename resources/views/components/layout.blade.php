    ...
    @else
        <style>
            ...
            *,
            ...
            .border-\[\#0575E6\] {
                --tw-border-opacity: 1;
                border-color: rgb(5 117 230 / var(--tw-border-opacity))
            }

            .bg-\[\#0575E6\]\/10 {
                background-color: rgb(5 117 230 / 0.1)
            }
            ...
            .hover\:scale-105:hover {
                ...
                transform: scale(var(--tw-transform-scale))
            }

            .hover\:bg-\[\#0575E6\]:hover {
                --tw-bg-opacity: 1;
                background-color: rgb(5 117 230 / var(--tw-bg-opacity))
            }
            ...
            .focus-visible\:ring-\[\#0575E6\]:focus-visible {
                --tw-ring-opacity: 1;
            ...
            @media (prefers-color-scheme: dark) {
                ...
                .dark\:focus-visible\:ring-\[\#0575E6\]:focus-visible {
                    --tw-ring-opacity: 1;
                    --tw-ring-color: rgb(5 117 230 / var(--tw-ring-opacity))
                }
            ...
            <div class="relative w-full max-w-7xl mx-auto px-6 lg:px-8">
                <div class="flex items-center justify-between py-4 lg:py-5">
                    ...
                    <div class="flex items-center space-x-3 group">
                        ...
                        <img src="{{ asset('images/logo.png') }}" alt="Ordecity Logo"
                ...
                <div id="mobile-menu"
                    ...
                    <div class="px-6 py-6 space-y-5">
                        ...
                        <a href="/about" class="block text-gray-600 hover:text-[#0575E6] font-semibold text-lg">
                            About
                        </a>
